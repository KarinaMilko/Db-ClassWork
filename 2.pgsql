...
-- Відібрати телефони, новіші 2022+ року випуску
...
-- Відібрати телефони не 2022 року
SELECT *
FROM phones
...
-- Знайти телефони або з батареєю від 4500  або з екраном від 6.6      
SELECT *
FROM phones
...
-- Знайти телефони від 700 до 900
SELECT *
FROM phones 
...
-- Знайти телефони від 2021 до 2022 року випуску
SELECT *
FROM phones
WHERE EXTRACT (YEAR FROM release_date) 
               BETWEEN 2021 AND 2022;

-- Відобразити телефони 
...
-- Знайти телефони марки Samsung або Xiaomi або Sony
SELECT *
FROM phones
WHERE brand = 'Samsung' 
      OR brand = 'Xiaomi' 
...
-- Телефони випущених взимку або влітку
SELECT *
FROM phones
...
-- = NULL
-- відобразити телефони без заданої ціни
SELECT *
FROM phones
WHERE price IS NULL;

-- <> NULL
-- відобразити телефони з ціною
SELECT *
FROM phones
...
-- Додати стовпчик для номера id-картки (паспорта)
ALTER TABLE users 
...
-- Додати поле для паспорта-книжки AA000000
ALTER TABLE users
